...
func TestSign(t *testing.T) {
	tests := []struct {
		...
		{key: "some bytes", message: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0}, receivedSignedMessage: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0, Signature: []byte{31, 137, 186, 164, 173, 211, 74, 222, 39, 149, 108, 62, 70, 131, 158, 11, 71, 31, 57, 246, 234, 41, 221, 245, 167, 205, 238, 97, 49, 245, 160, 120}}, isValid: true, expectedError: ""},
		{key: "some bytes", message: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0}, receivedSignedMessage: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0, Signature: []byte{32, 137, 186, 164, 173, 211, 74, 222, 39, 149, 108, 62, 70, 131, 158, 11, 71, 31, 57, 246, 234, 41, 221, 245, 167, 205, 238, 97, 49, 245, 160, 120}}, isValid: false, expectedError: ""},
	}
...
func TestSignVerify(t *testing.T) {
	tests := []struct {
		...
		{key: "some bytes", message: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0}, expectedSignedMessage: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0, Signature: []byte{31, 137, 186, 164, 173, 211, 74, 222, 39, 149, 108, 62, 70, 131, 158, 11, 71, 31, 57, 246, 234, 41, 221, 245, 167, 205, 238, 97, 49, 245, 160, 120}}, isValid: true, expectedError: ""},
		{key: "some bytes", message: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0}, expectedSignedMessage: &v1.SteeringCommandVerificationOption{SteeringAngle: 6.0, Signature: []byte{32, 137, 186, 164, 173, 211, 74, 222, 39, 149, 108, 62, 70, 131, 158, 11, 71, 31, 57, 246, 234, 41, 221, 245, 167, 205, 238, 97, 49, 245, 160, 120}}, isValid: false, expectedError: ""},
	}
	for _, test := range tests {
		os.Setenv(ImplicitMessageIntegrityKey, test.key)
		err := test.message.Sign()
